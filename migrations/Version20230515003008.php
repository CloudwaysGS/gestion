 ...
 */
final class Version20230515003008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facture_detail (facture_id INT NOT NULL, detail_id INT NOT NULL, INDEX IDX_7B916D347F2DEE08 (facture_id), INDEX IDX_7B916D34D8D003BB (detail_id), PRIMARY KEY(facture_id, detail_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE detail DROP prix_unit_detail');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail ADD prix_unit_detail DOUBLE PRECISION DEFAULT NULL');
    }
}
