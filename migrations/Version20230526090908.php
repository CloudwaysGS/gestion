 ...
 */
final class Version20230526090908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD connect VARCHAR(255) NOT NULL, DROP user_id');
        ...
        $this->addSql('ALTER TABLE facture2 ADD connect VARCHAR(255) NOT NULL, DROP user_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE facture ADD user_id INT DEFAULT NULL, DROP connect');
        ...
        $this->addSql('ALTER TABLE facture2 ADD user_id INT DEFAULT NULL, DROP connect');
