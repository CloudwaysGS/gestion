 ...
 */
final class Version20231231122928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dette_chargement (dette_id INT NOT NULL, chargement_id INT NOT NULL, INDEX IDX_77F386A5E11400A1 (dette_id), INDEX IDX_77F386A5B8FBE502 (chargement_id), PRIMARY KEY(dette_id, chargement_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
